...
public class Driver {
    ...
    // Declares new hash maps for dog, monkey and monkey species map
    ...
    public static void initializeDogList() {
        ...
        // Adds dogs to a map for testing
    ...
    public static void initializeMonkeyList() {
        ...
        //adds the attributes from monkey object to monkey map
    ...
    // The input validation to check that the dog is not already in the list
    	public static void intakeNewDog(Scanner scanner) {
            ...
            //adds all attribute data to dog map with name as key and newDog as value
            dogMap.put(newDog.getName(), newDog);
    } 
        ...
        public static void intakeNewMonkey(Scanner scanner) {
          ...
          //Checks to see in monkey is already in the system.
            ...
            //adds all attribute data to monkey map with name as key and newMonkey as value
            monkeyMap.put(newMonkey.getName(), newMonkey);
        }
        ...
        public static void printAnimals(String animalPrint) {
        	...
        	case"dog":
        		...
        		for(Dog dog: dogMap.values()) {//iterates through the array using dog as the temp variable
        	...
        	case "monkey":
        		System.out.println("Name      Status         Acq. Country        Reserved    ");
            	for(Monkey monkey: monkeyMap.values()) {//iterates through the array using monkey as the temp variable 
